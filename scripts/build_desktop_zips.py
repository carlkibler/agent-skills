...
top-level folder (e.g. pre-mortem/SKILL.md), which is what the desktop
...
Usage:
    ...
    python3 scripts/build_desktop_zips.py pre-mortem # build one
...
GROUP_ORDER = ["For Anyone", "Product & Launch", "Dev Workflow"]
GROUP_INTROS = {
